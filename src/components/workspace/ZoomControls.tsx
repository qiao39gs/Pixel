...
export default function ZoomControls() {
  ...
  return (
    <div className={`absolute z-30 flex items-center gap-0.5 glass-toolbar rounded-xl px-1 py-1 animate-toolbar-pop transition-all right-3 ${rightOpen ? 'bottom-[420px]' : 'bottom-3'}`} title="滚轮缩放 · Ctrl/Cmd + 滚轮">
