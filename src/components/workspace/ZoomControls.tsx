...
export default function ZoomControls() {
  ...
  return (
    <div className={`zoom-controls absolute z-20 flex items-center gap-0.5 glass-toolbar rounded-xl px-1 py-1 animate-toolbar-pop right-3 transition-[bottom] duration-200 ${editMode ? 'max-sm:bottom-[72px]' : 'bottom-3'}`} title="滚轮缩放 · Ctrl/Cmd + 滚轮">
